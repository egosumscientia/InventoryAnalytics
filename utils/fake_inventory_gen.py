...
import openpyxl  # noqa: F401 - needed for Excel writing
import pandas as pd
...
def generar_codigo(index: int) -> str:
...
def generar_nombre(categoria: str) -> str:
    nombres = {
...
def generar_inventario(num_items: int = 1000):
    inventario = []
...
def guardar_inventario(inventario, nombre_base: str = "inventario") -> None:
